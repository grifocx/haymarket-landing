    ...
    <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2 overflow-hidden border-t-4" style={{ borderColor: service.highlightColor }}>
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          <h3 className="font-montserrat text-2xl font-bold text-[#144D3A] flex-1">
            {service.title}
          </h3>
          <div
            className="font-montserrat px-4 py-2 rounded-full text-white font-bold shadow-md ml-4 flex-shrink-0"
